        ...
        private AnimationDefinition MonolithEmissive => new AnimationDefinition
        {
            ...
            WeaponAnimationSets = new[]
            {
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, TurnOn, TurnOff, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, -0.58, 0.62), //linear movement
                                    },
                                    Rotation = Transformation(5, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees, rotates around CenterEmpty
                                },
								new RelMove
                                {
                                    CenterEmpty = "",//Specifiy an empty on the subpart to rotate around
                                    TicksToMove = 2600, //number of ticks to complete motion, 60 = 1 second
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0.62, -0.58, 0), //linear movement
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees, rotates around CenterEmpty
                                },
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, -0.58, -0.62), //linear movement (x=L,R y=U,D z=F,B)
                                    },
                                    Rotation = Transformation(-5, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees, rotates around CenterEmpty
                                },
				...
				new PartAnimationSetDef()
                {
                    ...
                    StartupFireDelay = 0,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(Overheated), // (Firing, Overheated)
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(-0.5, 1, -0.5), //linear movement x=L,R y=U,D z=F,B
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees, rotates around CenterEmpty
                                },
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                new RelMove
                                {
                                    ...
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0.8, 0), //linear movement x=L,R y=U,D z=F,B
                                    },
                                    Rotation = Transformation(0, 0, 0), //degrees
                                    RotAroundCenter = Transformation(0, 0, 0), //degrees, rotates around CenterEmpty
                                },
