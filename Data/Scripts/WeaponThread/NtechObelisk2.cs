...
{   // Don't edit above this line
    partial class Weapons
    {
        WeaponDefinition NtechObelisk2 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[]
                {
                    new MountPointDef
                    {
                        ...
                        AimPartId = "elevation_02",
                        MuzzlePartId = "elevation_02",
                        AzimuthPartId = "azimuth02",
                        ElevationPartId = "elevation_02",
                    },
            ...
            {
                WeaponName = "Obelisk Laser 1", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "ElectricDischarge1", // Smoke_LargeGunShot LaserImpactParticle
