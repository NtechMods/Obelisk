...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition NtechObelisk2 => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "NtechObelisk", aimPartId:"elevation_02", muzzlePartId: "elevation_02", azimuthPartId: "azimuth02", elevationPartId: "elevation_02"),
                },
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.09f, elevateRate: 0.09f, minAzimuth: -180, maxAzimuth: 180, minElevation: -180, maxElevation: 180, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, inventorySize: 0.34f, debug: false),
                DeviateShotAngle = 0f,
			...
			Animations = MonolithEdgeCrystals1, //link to animation config
